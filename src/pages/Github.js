...
const About = () => {
  return (
    <main id="about" className={`py-20 bg-blue-500 text-white`}>
      <Container>
        <div className="mx-auto flex flex-col justify-center items-center">
            <Title text="Meu GitHub" />
            <p className="text-2xl pb-10">Já desenvolvi Mais + de <span className="text-blue-700">100 projetos</span> em meu GitHub, venha conferir!</p>
